...
struct StoryBrain{
    ...
    mutating func nextStory(choice : String){
        ...
        if Destini[storyNumber].choice1 == choice {
            storyNumber = Destini[storyNumber].choice1Destination
            
        }else if Destini[storyNumber].choice2 == choice {
            storyNumber = Destini[storyNumber].choice2Destination
